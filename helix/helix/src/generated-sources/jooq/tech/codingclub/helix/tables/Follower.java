...
public class Follower extends org.jooq.impl.TableImpl<tech.codingclub.helix.tables.records.FollowerRecord> {
	...
	private static final long serialVersionUID = -489029647;
	...
	public java.util.List<org.jooq.ForeignKey<tech.codingclub.helix.tables.records.FollowerRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<tech.codingclub.helix.tables.records.FollowerRecord, ?>>asList(tech.codingclub.helix.Keys.FOLLOWER__FOLLOWER_USER_ID_FKEY1, tech.codingclub.helix.Keys.FOLLOWER__FOLLOWER_FOLLOWING_ID_FKEY1);
	}
